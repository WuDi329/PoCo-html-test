...
class MP4PullDemuxer extends PullDemuxerBase {
    source;
    readySamples;
    over = false;
    _pending_read_resolver;
    streamType = 0;
    audioTrack;
    videoTrack;
    selectedTrack;
    ...
    _getAvcDescription(avccBox) {
        const stream = new mp4box_all.DataStream(undefined, 0, mp4box_all.DataStream.BIG_ENDIAN);
...
class MP4Source {
    ...
    _onSamples;
    constructor(buffer) {
        this.file = mp4box_all.createFile();
...
async function supported_video_configs(constraints, all_if_no_webcodecs) {
...
async function max_video_config(constraints) {
...
export { AUDIO_STREAM_TYPE as A, DECODER_QUEUE_SIZE_MAX as D, ENCODER_QUEUE_SIZE_MAX as E, MP4PullDemuxer as M, SampleLock as S, VIDEO_STREAM_TYPE as V, WebmMuxer as W, ENABLE_DEBUG_LOGGING as a, debugLog$1 as d, max_video_config as m, supported_video_configs as s };
//# sourceMappingURL=SampleLock-727057f9.js.map
